...
class PetiteCaisse extends Component
{
    ...
    public function imprimer(){
        ...
        $pdf = Pdf::loadHTML(Blade::render('petitecaisse', ['loyers' => $this->loyers,'depenses' => $this->depenses, 'garanties' => $this->garanties, 'label' => 'Petite caisse']))->setPaper('a4', 'portrait');
