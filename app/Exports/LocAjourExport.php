...
class LocAjourExport implements FromCollection, WithHeadings, WithMapping, WithEvents, WithColumnFormatting, WithStyles
{
    public $mois;
    public $annee;
    ...
    */
    public function collection()
    {
        ...
        ->get()
        ->filter(function($dt){
            return $dt->somme == $dt->occupation->montant; // Filtrer les locataires qui ont déjà payé
        });
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getStyle("D{$lastRow}:F{$lastRow}")->applyFromArray([
                    'font' => ['bold' => true],
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            ...
            // **Body Rows Style**
            'A2:F'.($this->rows + 1) => [ // Adjust range as needed
