...
<aside
    ...
    @endif
    @class([
        'fi-sidebar fixed inset-y-0 start-0 z-30 flex flex-col h-screen content-start bg-blue-600 transition-all dark:bg-gray-900 lg:z-0 lg:shadow-none lg:ring-0 lg:transition-none dark:lg:bg-transparent',
...
>
    <div class="overflow-x-clip">
        <header
            class="fi-sidebar-header flex h-16 items-center bg-blue-600 px-6 ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 lg:shadow-sm"
        >
            <div
